...
st.write("###### CPF Details")
cpf_bal = st.number_input("Current CPF Balance")
...
current_age = st.number_input("Current Age", value=20)
...
if current_age and buying_age and buying_month:
